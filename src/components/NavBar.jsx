...
const NavBar = () => {
    ...
    return (
      <div className='flex items-center justify-between py-5 w-full px-5 sm:px-10  shadow-md relative text-2xl'>
        <Link to='/'>
          <img src={assets.logomahantam} className='w-[64px]' alt="Trendify" /> 
        </Link>
        <ul className='hidden gap-5 text-xl text-gray-700 sm:flex'>
